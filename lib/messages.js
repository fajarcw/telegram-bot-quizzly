...
*Важно!*
- Если пропала клавиатура, просто нажмите на символ \`[::]\`
- Обращайте вниание на кнопки с ответами. Иногда их бывает много и они не все помещаются на экране. Попробуйте прокрутить варианты ответов

Сегодня, *13.10.16* по итогам каждого часа будет выбран победитель. В другие дни ты сможешь просто проходить тест для души и самообразования.
