...
*Важно!*
- Если пропала клавиатура, просто нажми на символ \`[::]\`
- Обращай вниание на кнопки с ответами. Иногда их бывает много и они не все помещаются на экране. Попробуй прокрутить варианты ответов
